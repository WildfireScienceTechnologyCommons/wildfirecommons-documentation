...
**NOTE:** You must log out and log in within JupyterHub, not the main FireForge site. If you go to the main FireForge site to log out and log in again, your JupyterHub access token will not be reset. 
